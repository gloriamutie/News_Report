...
//        Sql2o sql2o = new Sql2o(connectionString, "gloria", "gloria@2018");  //Ubuntu Sql2o sql2o = new Sql2o(connectionString, "user", "1234");
       ...
       String connectionString = "jdbc:postgresql://ec2-23-23-242-234.compute-1.amazonaws.com:5432/d4534eccoll4vm";
       Sql2o sql2o = new Sql2o(connectionString, "qxvvrqaqshhihh", "6c8cf808b3da37fa060be152de0a5af24fca53ade89bc0f1dbccc796b409e9ae");
